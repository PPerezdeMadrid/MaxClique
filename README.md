...
src/
  ...
  search3.py            # Greedy Colouring Bound variant (explanation in /doc)
  search4.py            # Index Ordering Colouring variant (explanation in /doc)
